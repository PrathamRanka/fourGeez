...
- [ ] **API-005** Implement approval-session and decision endpoints.
...
- [ ] **PAY-001** Verify the selected official x402 Go SDK version and record it in `SOURCES.md` before adding the dependency.
- [ ] **PAY-002** Implement a payment adapter interface and deterministic mock adapter.
