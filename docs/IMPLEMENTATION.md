...
- [ ] **WEB-013** Restore the existing cloud-call-to-action footer on public routes through the shared application shell while keeping authenticated dashboard routes footer-free. Depends on SITE-001.
