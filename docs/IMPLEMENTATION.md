...
- [ ] **WEB-014** Consolidate public decorative gradients and shader accents on the landing palette: ink black, electric blue, signal pink, and payment orange. Restyle the cloud CTA footer as a permanent black surface with subtle graphite clouds and restrained palette edge light while preserving semantic success, warning, error, and chart colors. Depends on WEB-013.
