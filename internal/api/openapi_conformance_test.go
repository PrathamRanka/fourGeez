...
func TestOpenAPILaunchTargetOperationAndResponseCoverage(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"disableWebhookSubscription":              {"200", "400", "401", "403", "404", "409", "429", "503"},
...
func TestImplementedOpenAPIRoutesAreRegistered(t *testing.T) {
	...
	tests := []struct {
		...
		{operationID: "disableWebhookSubscription", method: http.MethodPost, path: "/v1/sellers/sel_01K5D09YJ0C0M7RJM4FWQ0K9H7/webhook-subscriptions/whk_01K5D09YJ0C0M7RJM4FWQ0K9H7/disable", wantStatus: http.StatusUnauthorized},
